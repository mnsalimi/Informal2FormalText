        ...
        for line in file:
            ...
            if not line.startswith("#"):
                if line is not "\n":
                    ...
                    # print("tokens", tokens)
                    # print("tokens_column", tokens_column)
                    # print("predict_column", predict_column)
                    ...
                    # print("else line", line)
                    # print("else line ascci code", ord(line))
                    # print("len(list_tokens)", len(list_tokens))
                    ...
                    list_tokens = []
                    list_labels = []
    # print("list_all_tokens0", list_all_tokens)
    assert len(list_all_tokens) == len(list_all_labels) == len(list_all_masks)
    # print("list_all_tokens1", list_all_tokens)
